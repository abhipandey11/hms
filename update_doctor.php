...
<body>
    <div class="doctors-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["search_attribute"]) && isset($_POST["search_value"])) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<table>";
                echo "<thead><tr><th>ID</th><th>Name</th><th>Age</th><th>Gender</th><th>Department</th><th>Contact</th><th>Action</th></tr></thead>";
                echo "<tbody>";
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='update_doctor_details.php?id=" . $row["Doctor_Id"] . "'>Update</a></td>";
                    echo "</tr>";
                }
                echo "</tbody>";
                echo "</table>";
            } else {
                echo "No doctors/staff found.";
            }
        }
        ?>
